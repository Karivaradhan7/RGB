...
set RTSP_URL=rtsp://admin:Mahesh@2025@103.59.107.2:554/Streaming/channels/101
set ALERT_EMAIL=karivaradhan7@gmail.com
...
echo    cd /tmp/cc-agent/61354207/project/frontend
echo    npm install
echo    npm run dev
